...
public class Haodaili {
	...
	public static void main(String[] args) {
		...
		String location="";
		String lastTime="";
		String url = "http://www.haodailiip.com/";
		Document document1 = getDoc(url);
		
		Elements elements1 = document1.select(".proxy_table tr");
		...
		for (Element element : elements1) {
			try {
			     ...
			     location=element.select("td:nth-child(3)").text();
			     lastTime=element.select("td:nth-child(6)").text();
				 ip_port=ip+":"+port;
